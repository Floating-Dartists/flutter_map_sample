...
class NewPolylineLayer extends StatelessWidget {
  final NewPolylineLayerOptions polylineOpts;
  final MapState map;
  // ignore: prefer_void_to_null
  final Stream<Null>? stream;

  NewPolylineLayer(this.polylineOpts, this.map, this.stream)
  ...
  Widget _build(BuildContext context, Size size) {
    return StreamBuilder<void>(
      ...
      builder: (BuildContext context, _) {
        ...
        return Stack(children: polylines);
      },
    );
  }
...
class NewPolylinePainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant NewPolylinePainter oldDelegate) => false;
}
